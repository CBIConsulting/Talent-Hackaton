...
Dispondrás del número total de intersecciones y un array de carreteras, cada una de ellas 
con las propiedades: `from`, `to` (las interesecciones están etiquetadas con números 
enteros menores que el número de intersecciones) y `drivingTime`. Las carreteras sólo 
pueden ser usadas para ir desde `from` a
